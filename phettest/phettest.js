...
document.getElementById( 'perennialRefresh' ).addEventListener( 'click', function() {
  ...
  $.ajax( 'http://' + domain + ':45362/perennial-refresh' ).done( function( data ) {
    $( status ).text( '' );
  ...
  $.ajax( 'http://' + domain + ':45362/sim-list' ).done( function( data ) {
    ...
    $.ajax( 'http://' + domain + ':45362/repo-list' ).done( function( data ) {
      ...
      _.each( commonRepos, function( commonRepoName ) {
        ...
        actionCell( 'Pull', 'http://' + domain + ':45362/pull?sim=' + commonRepoName );
...
function updateSims() {
  ...
  $.ajax( 'http://' + domain + ':45362/sim-list' ).done( function( data ) {
    ...
    _.each( sims, function( simName ) {
      ...
      linkCell( 'Built Version', 'http://' + domain + '/' + simName + '/build/phet/' + simName + '_en_phet.html' );
