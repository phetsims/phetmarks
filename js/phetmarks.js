        ...
        $.ajax( {
          ...
          $.ajax( {
            ...
            $.ajax( {
              ...
              render( populate( activeRunnables, activeRepos, phetioSims, interactiveDescriptionims, [ 'phet-io-wrappers/active', 'phet-io-wrappers/api-diff', 'phet-io-wrappers/event-log', 'phet-io-wrappers/index', 'phet-io-wrappers/studio', 'phet-io-wrappers/login', 'phet-io-wrappers/mirror-inputs', 'phet-io-wrappers/multi', 'phet-io-wrappers/record', 'phet-io-wrappers/playback', 'phet-io-wrappers/screenshot', 'phet-io-wrappers/state', 'phet-io-wrappers/wrapper-template', 'phet-io-wrapper-classroom-activity', 'phet-io-wrapper-lab-book' ], colorProfileRepos, unitTestsRepos ) );
            } );
          } );
        } );
      } );
